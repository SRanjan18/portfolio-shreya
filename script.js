...
function drawPipeline() {
  ...
  if (light) {
    panel.addColorStop(0, "rgba(20,184,166,.30)");
    panel.addColorStop(.32, "rgba(14,165,233,.22)");
    panel.addColorStop(.66, "rgba(168,85,247,.12)");
    panel.addColorStop(1, "rgba(255,255,255,.06)");
  } else {
  ...
  pipelineCtx.globalAlpha = light ? .48 : .22;
  pipelineCtx.strokeStyle = light ? "rgba(13,148,136,.42)" : "rgba(0,191,255,.15)";
  ...
  paths.forEach((path, index) => {
    ...
    if (light) {
      gradient.addColorStop(0, index === 2 ? "rgba(15,23,42,.72)" : "rgba(13,148,136,1)");
      gradient.addColorStop(.5, index === 2 ? "rgba(51,65,85,.62)" : "rgba(37,99,235,.95)");
      gradient.addColorStop(1, index === 2 ? "rgba(15,23,42,.72)" : "rgba(14,165,233,1)");
    } else {
    ...
    pipelineCtx.lineWidth = light ? (index === 2 ? 2.45 : 3.65) : (index === 2 ? 1.25 : 2.2);
  ...
  for (const packet of pipelinePackets) {
    ...
    pipelineCtx.shadowColor = light ? `${color}bb` : color;
    pipelineCtx.shadowBlur = light ? 14 : 18;
    pipelineCtx.beginPath();
  ...
  nodes.forEach((node, index) => {
    ...
    if (light) {
      glow.addColorStop(0, `rgba(20,184,166,${.34 + impact * .16})`);
      glow.addColorStop(.34, "rgba(14,165,233,.24)");
      glow.addColorStop(.68, "rgba(168,85,247,.12)");
